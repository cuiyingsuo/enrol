...
public class Bill {
     ...
     * post 支付 方式名称
     */
    @Column(name = "pos_pay_method")
    private String posPayMethod;
    ...
    public String getPosPayMethod() {
        return posPayMethod;
    }

    public void setPosPayMethod(String posPayMethod) {
        this.posPayMethod = posPayMethod;
    }
