...
public class OrderFlow {
    ...
    @Column(name = "receivables_campus_code")
    private String receivablesCampusCode;
    ...
    public String getReceivablesCampusCode() {
        return receivablesCampusCode;
    }

    public void setReceivablesCampusCode(String receivablesCampusCode) {
        this.receivablesCampusCode = receivablesCampusCode;
    }
