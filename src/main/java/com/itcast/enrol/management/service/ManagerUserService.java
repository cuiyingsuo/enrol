...
import com.itcast.enrol.common.dao.user.UserMapper;
import com.itcast.enrol.common.entity.User;
import com.itcast.enrol.common.exception.LoginException;
import com.itcast.enrol.common.utils.AesUtil;
 ...
 **/
@Service
public class ManagerUserService extends BaseService<User> {

    private static BusLogUtil busLogUtil = new BusLogUtil(ManagerUserService.class);
